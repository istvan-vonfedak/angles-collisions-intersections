...
struct Point {
  ...
  static const double angle(const Point p1, const Point p2,
  ...
  static const bool collision(const Point p1, const Point p2,
...
struct Line {
  ...
  static const bool collision(Line line1, Line line2,
                              Point & inter, const double tolerance = 0.001)
